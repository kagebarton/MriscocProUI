...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  48.40        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.20       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  44.40        // (Hz) The default dominant resonant frequency on the Y axis.
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT       1     // Maximum number of sorted items (10-256). Costs 27 bytes each.
