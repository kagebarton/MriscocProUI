...
void do_blocking_move_to_x(const_float_t rx, const_feedRate_t fr_mm_s/*=0.0*/) {
  SERIAL_ECHOLNPGM("do_blocking_move_to_x(", rx, ", ", fr_mm_s, ")");
  do_blocking_move_to(
  ...
  void do_blocking_move_to_y(const_float_t ry, const_feedRate_t fr_mm_s/*=0.0*/) {
    SERIAL_ECHOLNPGM("do_blocking_move_to_y(", ry, ", ", fr_mm_s, ")");
    do_blocking_move_to(
  ...
  void do_blocking_move_to_z(const_float_t rz, const_feedRate_t fr_mm_s/*=0.0*/) {
    SERIAL_ECHOLNPGM("do_blocking_move_to_z(", rz, ", ", fr_mm_s, ")");
  ...
  void do_blocking_move_to_xy(const_float_t rx, const_float_t ry, const_feedRate_t fr_mm_s/*=0.0*/) {
    SERIAL_ECHOLNPGM("do_blocking_move_to_xy(", rx, ", ", ry, ", ", fr_mm_s, ")");
    do_blocking_move_to(
  ...
  void do_z_clearance(const_float_t zclear, const bool lower_allowed/*=false*/) {
    SERIAL_ECHOLNPGM("do_z_clearance(", zclear, ", ", lower_allowed, ")");
