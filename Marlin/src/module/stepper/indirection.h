...
#elif E_STEPPERS
  #define E_STEP_WRITE(E,V) E0_STEP_WRITE(V)
  #define   NORM_E_DIR(E)   E0_DIR_WRITE(TERN(ProUIex, !INVERT_E0_DIR, INVERT_DIR(E0, HIGH)))
  #define    REV_E_DIR(E)   E0_DIR_WRITE(TERN(ProUIex, INVERT_E0_DIR, INVERT_DIR(E0, LOW )))
